        ...
        static GeneralResponse from(ResultSet resultSet) {
            try {
                return new GeneralResponse(
                        ...
                        new Count(resultSet.getMetaData().getColumnName(18), resultSet.getInt("cnt_prioritization")),
                        ...
                        new Count(resultSet.getMetaData().getColumnName(27), resultSet.getInt("cnt_guerrilla_testing")),
                        ...
                        new Count(resultSet.getMetaData().getColumnName(33), resultSet.getInt("cnt_mobbing")),
